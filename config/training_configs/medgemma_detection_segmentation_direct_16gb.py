# Direct MedGemma Detection + Segmentation Configuration
# Uses direct JSONL loading without dataset registration
...
# Data Configuration - Direct file loading
data_args = dict(
    # Direct dataset parameters
    ...
    # Dataset type override (for custom loading)
    dataset_type='jsonl',
)
...
training_args = dict(
    # Output
    output_dir='./exp/medgemma_detection_seg_direct_16gb',
    logging_dir='./exp/medgemma_detection_seg_direct_16gb/logs',
    ...
    run_name='medgemma_detection_seg_direct_16gb',
)